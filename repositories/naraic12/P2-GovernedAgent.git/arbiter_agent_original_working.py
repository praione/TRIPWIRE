...
class ArbiterAgent:
    ...
    def _execute_constitutional_veto(self, veto_key: str) -> None:
        ...
        try:
            ...
            veto_command = { "command": "constitutional_veto", "authority": "arbiter_agent", "reason": "Constitutional crisis detected - quorum threshold reached", "veto_key": veto_key, "timestamp": datetime.now(timezone.utc).isoformat(), "source_agents": [s['source_agent'] for s in self.collected_shares] }
