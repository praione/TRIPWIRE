...
class CorrectedShamirSecretSharing:
    ...
    def _fetch_shared_polynomial(self) -> List[int]:
        ...
        try:
            ...
            logger.info(f"TRIPWIRE DEBUG: SUCCESS - Retrieved polynomial from Secret Manager: {str(coefficients)[:80]}...")
            return coefficients
            ...
            coefficients = self._create_local_polynomial()
            logger.warning(f"TRIPWIRE DEBUG: Generated LOCAL polynomial: {str(coefficients)[:80]}...")
            return coefficients
