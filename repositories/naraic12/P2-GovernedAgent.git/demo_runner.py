...
from pipeline_wrapper import EnhancedPipelineWrapper
...
class DemoRunner:
    ...
    def run_demo(self, goal: str) -> Dict[str, Any]:
        ...
        self.wrapper = EnhancedPipelineWrapper()
...
def main():
    ...
    parser.add_argument("--simulate-vertex-outage", action="store_true",
                       help="Simulate Vertex AI outage for resilience testing")
    
    args = parser.parse_args()
    # Simulate Vertex AI outage if requested
    if args.simulate_vertex_outage:
        print("\n" + "="*60)
        print("🔴 DEMO MODE: Simulating Vertex AI Service Outage")
        print("="*60 + "\n")
